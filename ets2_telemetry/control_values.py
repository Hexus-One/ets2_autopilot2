...
def get_input_values(telemetry_memory_map):
    ...
    return {
        ...
        "throttle": struct.unpack("I", telemetry_memory_map[784:788])[0],
        "brake": struct.unpack("Q", telemetry_memory_map[792:796])[0],
        "clutch": struct.unpack("Q", telemetry_memory_map[796:800])[0],
    }
...
def get_game_values(telemetry_memory_map):
    ...
    return {
        ...
        "throttle": struct.unpack("I", telemetry_memory_map[804:808])[0],
        "brake": struct.unpack("Q", telemetry_memory_map[808:812])[0],
        "clutch": struct.unpack("Q", telemetry_memory_map[812:816])[0],
    }
